        ...
        this.primitives = {
            segments: new CustomPrimitive({
                ...
                vertexShaderSource: new Cesium.ShaderSource({
                    sources: [Util.loadText(gui.fileOptions.glslDirectory + 'segmentDraw.vert')]
                }),
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [Util.loadText(gui.fileOptions.glslDirectory + 'segmentDraw.frag')]
                }),
            ...
            trails: new CustomPrimitive({
                ...
                vertexShaderSource: new Cesium.ShaderSource({
                    ...
                    sources: [Util.loadText(gui.fileOptions.glslDirectory + 'fullscreen.vert')]
                }),
                fragmentShaderSource: new Cesium.ShaderSource({
                    defines: ['DISABLE_LOG_DEPTH_FRAGMENT_WRITE'],
                    sources: [Util.loadText(gui.fileOptions.glslDirectory + 'trailDraw.frag')]
                }),
                rawRenderState: Util.createRawRenderState({
                    viewport: undefined,
                    depthTest: {
            ...
            screen: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    defines: ['DISABLE_LOG_DEPTH_FRAGMENT_WRITE'],
                    sources: [Util.loadText(gui.fileOptions.glslDirectory + 'screenDraw.frag')]
                }),
                rawRenderState: Util.createRawRenderState({
                    viewport: undefined,
                    depthTest: {
